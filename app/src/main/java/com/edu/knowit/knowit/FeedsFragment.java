...
public class FeedsFragment extends android.support.v4.app.Fragment {
    ...
    public void onStart() {
        ...
        dataModels.add(new FeedsItemModel("dsdada1231","Kavini","2017-01-12","MIT","","If I want to add third child that must be under the first one, but it is not?","","",""));
        dataModels.add(new FeedsItemModel("dsdada1231","Sithira","2017-01-12","MIT","","To create a linear layout in which each child uses the same amount of space on the screen, set the android:layout_height of each view to","","",""));
